...
`,this.stylePanel.style.display="block"}traverseDOM(t,e){if(!this.isInternal(t)){t.nodeType===Node.ELEMENT_NODE&&e(t);for(let i=0;i<t.childNodes.length;i++)this.traverseDOM(t.childNodes[i],e)}}applyWire(t){this.traverseDOM(document.body,e=>{e.classList.toggle(`${this.opts.prefix}dbg-outline`,t)}),this.state.wire=t}applyGrid(t){this.gridEl&&(this.gridEl.style.display=t?"block":"none"),this.state.grid=t}applyTags(t){this.traverseDOM(document.body,e=>{let i=e;if(t){let s=Array.from(i.classList).filter(a=>!a.startsWith(this.opts.prefix??"")),o=i.tagName.toLowerCase()+(i.id?`#${i.id}`:"")+(s.length?` .${s.join(".")}`:"");i.dataset.dbg=o}else delete i.dataset.dbg;i.classList.toggle(`${this.opts.prefix}dbg-tag`,t)}),this.state.tags=t}toggleMode(t,e){let i={wire:a=>this.applyWire(a),highlight:a=>this.state.highlight=a,grid:a=>this.applyGrid(a),tags:a=>this.applyTags(a),styleInfo:a=>this.state.styleInfo=a},o=!this.state[t];i[t](o),e&&e.classList.toggle(`${this.opts.prefix}active`,o)}bindShortcuts(){let t=e=>{e.ctrlKey&&e.altKey&&e.code==="Pause"&&(this.applyWire(!1),this.applyGrid(!1),this.applyTags(!1),this.state.highlight=!1,this.state.styleInfo=!1,this.toolbarEl&&this.traverseDOM(this.toolbarEl,i=>{i.tagName==="BUTTON"&&i.classList.remove(`${this.opts.prefix}active`)}),this.overlayRoot&&(this.overlayRoot.style.display="none"),this.stylePanel&&(this.stylePanel.style.display="none"),this.state={wire:!1,grid:!1,tags:!1,highlight:!1,styleInfo:!1})};return window.addEventListener("keydown",t),()=>{window.removeEventListener("keydown",t)}}};typeof window<"u"&&(window.PseudoDebugKit=r);export{r as PseudoDebugKit};
